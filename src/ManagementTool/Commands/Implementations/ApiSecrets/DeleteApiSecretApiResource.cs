...
internal class DeleteApiSecretApiResource : ServiceClientOctoCommand<IIdentityServicesClient>
{
    ...
    public DeleteApiSecretApiResource(ILogger<DeleteApiSecretApiResource> logger, IOptions<OctoToolOptions> options,
        ...
        : base(logger, "DeleteApiSecretApiResource", "Deletes a secret of an API resource.", options, identityServicesClient, authenticationService)
    {
    ...
    public override async Task Execute()
    {
        ...
        Logger.LogInformation("Deleting API secret \'{SecretValue}\' for client \'{Name}\' from \'{ServiceClientServiceUri}\'", secretValue, name,
