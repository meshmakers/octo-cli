...
internal class GetLatestPipelineExecutionCommand : ServiceClientOctoCommand<ICommunicationServicesClient>
{
    private readonly IConsoleService _consoleService;
    private readonly IArgument _idArg;
    private readonly IArgument _jsonArg;

    public GetLatestPipelineExecutionCommand(ILogger<GetLatestPipelineExecutionCommand> logger,
        IOptions<OctoToolOptions> options,
        IConsoleService consoleService,
        ICommunicationServicesClient communicationServicesClient, IAuthenticationService authenticationService)
        : base(logger, Constants.CommunicationServicesGroup, "GetLatestPipelineExecution",
            "Returns the latest pipeline execution.", options,
    ...
    public override async Task Execute()
    {
        ...
        Logger.LogInformation(
            "Getting latest pipeline execution '{PipelineId}' for tenant '{TenantId}' at '{ServiceClientServiceUri}'",
        ...
        var result = await ServiceClient.GetLatestPipelineExecutionAsync(id);
