...
internal class GetPipelineDebugCommand : ServiceClientOctoCommand<ICommunicationServicesClient>
{
    private readonly IConsoleService _consoleService;
    private readonly IArgument _idArg;
    private readonly IArgument _jsonArg;

    public GetPipelineDebugCommand(ILogger<GetPipelineDebugCommand> logger, IOptions<OctoToolOptions> options,
        IConsoleService consoleService,
        ICommunicationServicesClient communicationServicesClient, IAuthenticationService authenticationService)
        : base(logger, Constants.CommunicationServicesGroup, "GetPipelineDebug",
            "Gets the debug state of a pipeline.", options,
    ...
    public override async Task Execute()
    {
        ...
        Logger.LogInformation(
            "Getting pipeline debug state '{PipelineId}' for tenant '{TenantId}' at '{ServiceClientServiceUri}'",
        ...
        var result = await ServiceClient.GetPipelineDebuggingAsync(id);
