...
internal class RemoveUserFromRole : ServiceClientOctoCommand<IIdentityServicesClient>
{
    ...
    public RemoveUserFromRole(ILogger<RemoveUserFromRole> logger, IOptions<OctoToolOptions> options,
        ...
        : base(logger, "RemoveUserFromRole", "Remove an user from a role", options, identityServicesClient, authenticationService)
    {
    ...
    public override async Task Execute()
    {
        ...
        Logger.LogInformation("Removing user \'{Name}\' from role \'{Role}\' at \'{ServiceClientServiceUri}\'", name, roleName,
