...
internal class AddUserToRole : ServiceClientOctoCommand<IIdentityServicesClient>
{
    ...
    public AddUserToRole(ILogger<AddUserToRole> logger, IOptions<OctoToolOptions> options,
        ...
        : base(logger, "AddUserToRole", "Adds an user to a role", options, identityServicesClient, authenticationService)
    {
    ...
    public override async Task Execute()
    {
        ...
        Logger.LogInformation("Adding user \'{Name}\' to role \'{Role}\' at \'{ServiceClientServiceUri}\'", name, roleName,
