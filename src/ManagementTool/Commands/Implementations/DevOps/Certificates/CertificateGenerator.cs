...
/// </summary>
internal class CertificateGenerator : ICertificateProvider
{
    ...
    public CertificateGenerator(string serverName)
    {
        ...
        _root = new Lazy<CertificatePair>(GenerateRootCertificate);
        _server = new Lazy<CertificatePair>(GenerateServerCertificate);
    }
    ...
    ///     <inheritdoc cref="CertificateGenerator(string)" path="/param[@name='serverName']" />
    /// </param>
    ...
    private CertificatePair GenerateRootCertificate()
    {
        ...
        try
        {
            ...
            return new CertificatePair(cert, key);
        }
        catch
        {
            key?.Dispose();
    ...
    private CertificatePair GenerateServerCertificate()
    {
        ...
        try
        {
            ...
            else if (IPAddress.TryParse(_serverName, out var ipAddress))
            {
            ...
            var generator = X509SignatureGenerator
        ...
        : X509Extension(new Oid("2.5.29.35"), CreateFromCertificate(certificate), critical)
    {
        ...
        private static byte[] CreateFromCertificate(X509Certificate2 certificate)
        {
            ...
            var skidBytes = Convert.FromHexString(skid.SubjectKeyIdentifier!);
